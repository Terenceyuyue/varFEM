function uh = varPoissonCR(Th,pde,Vh,quadOrder)
%varPoissonCR Poisson equation: Crouzeix-Raviart linear element
...
if nargin==2, Vh = 'CR'; quadOrder = 3; end % default: P1
...
if ~isempty(Th.elem1D)
    ...
    Cmat_u = getMat1d(pde.exactu,Th,quadOrder);
