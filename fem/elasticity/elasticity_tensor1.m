function u = elasticity_tensor1(node,elem,pde,bdStruct,option)
%elasticity_tensor1 solves linear elasticity equation using P1 element with
% bilinear form (sigma(u), epsilon(v))
%
%       u = [u1, u2]
