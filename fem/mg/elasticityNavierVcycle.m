function u = elasticityNavierVcycle(node,elem,pde,bdStruct,Pro,Res)
%elasticity_Navier solves linear elasticity equation of Navier form using P1 element by
