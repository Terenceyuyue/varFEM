function u = elasticityScalar(node,elem,pde,bdStruct)
%ElasticityScalar  Conforming P1 FEM of linear elasticity equation
%  Programming in the finite element space of each component
%
%       u = [u1, u2]
...
if ~isempty(elemN)
    ...
    F21 = sum(ne.*Sig1(:,[2,3]),2)./2; F22 = sum(ne.*Sig2(:,[2,3]),2)./2;
    FN = [F11,F12,F21,F22];
